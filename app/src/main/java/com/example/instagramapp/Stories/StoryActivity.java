package com.example.instagramapp.Stories;
...
public class StoryActivity extends AppCompatActivity {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    // progressBar.pause(); // Implement this functionality
                    return false;
                case MotionEvent.ACTION_UP:
                    long now = System.currentTimeMillis();
                    // progressBar.resume(); // Implement this functionality
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.ActivityStory_storiesProgrsssView); // Replace with your ProgressBar id
        ...
        reverse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // progressBar.reverse(); // Implement this functionality
            }
        });
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // progressBar.skip(); // Implement this functionality
            }
        });
    ...
    protected void onDestroy() {
        // progressBar.destroy(); // Implement this functionality
        super.onDestroy();
    }
    ...
    private void getStories(String userid){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // progressBar.setStoriesCount(images.size()); // <- set stories
                // progressBar.setStoryDuration(5000L); // <- set a story duration
                // progressBar.setStoriesListener(StoryActivity.this); // <- set listener
                // progressBar.startStories(counter); // <- start progress
